...
'/store/user/hmarques/MC_PbPb_X3872/MC_PbPb_20241120_prompt_X_to_Jpsi_Rho_phat5_miniAOD/241120_195815/0000/step4_MC_miniAOD_X2JpsiRho_phat5_PbPb_8.root',
]
...
process.onia2MuMuPatGlbGlb.dimuonSelection       = cms.string("2.7 < mass && mass < 3.3 && charge==0 && abs(daughter('muon1').innerTrack.dz - daughter('muon2').innerTrack.dz) < 25  && pt >3")
...
process.oniaTreeAna.replace(
    process.onia2MuMuPatGlbGlb, process.onia2MuMuPatGlbGlb * process.onia2MuMuPatGlbGlbFilter  * process.generalOttCandidatesNew * process.forest * process.ottana_mc_new
)
...
process.options.numberOfThreads = 15
